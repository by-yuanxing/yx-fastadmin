<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:54:"D:\phpstudy\WWW\test\addons\cms\view\default\user.html";i:1591855994;s:63:"D:\phpstudy\WWW\test\addons\cms\view\default\common\layout.html";i:1591855994;s:61:"D:\phpstudy\WWW\test\addons\cms\view\default\common\item.html";i:1591855994;}*/ ?>
<!DOCTYPE html>
<!--[if lt IE 7]>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav" data-current="<?php echo (isset($__CHANNEL__['id']) && ($__CHANNEL__['id'] !== '')?$__CHANNEL__['id']:0); ?>">
                    ...
                    <?php $__TrDQum6A7p__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav","type"=>"top","condition"=>"1=isnav"]); if(is_array($__TrDQum6A7p__) || $__TrDQum6A7p__ instanceof \think\Collection || $__TrDQum6A7p__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__TrDQum6A7p__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
                    <!--判断是否有子级或高亮当前栏目-->
                    <li class="<?php if($nav['has_child']): ?>dropdown<?php endif; if($nav->is_active): ?> active<?php endif; ?>">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <?php $__Ui0SBA2u3h__ = \addons\cms\model\Channel::getChannelList(["id"=>"sub","type"=>"son","typeid"=>$nav['id'],"condition"=>"1=isnav"]); if(is_array($__Ui0SBA2u3h__) || $__Ui0SBA2u3h__ instanceof \think\Collection || $__Ui0SBA2u3h__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__Ui0SBA2u3h__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub): $mod = ($i % 2 );++$i;?>
                            <li><a href="<?php echo $sub['url']; ?>"><?php echo $sub['name']; ?></a></li>
                            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__Ui0SBA2u3h__; ?>
                        </ul>
                    </li>
                    <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__TrDQum6A7p__; ?>
                    <!--如果需要无限级请使用cms:nav标签-->
...
<div class="container" id="content-container">
    ...
    <?php endif; ?>
                        ...
                        <?php else: if(config('cms.loadmode')=='paging'): ?>
