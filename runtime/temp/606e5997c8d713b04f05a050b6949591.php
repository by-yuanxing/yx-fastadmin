<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:69:"D:\phpstudy\WWW\test\public/../application/index\view\user\login.html";i:1592471721;s:63:"D:\phpstudy\WWW\test\application\index\view\layout\default.html";i:1591338017;s:60:"D:\phpstudy\WWW\test\application\index\view\common\meta.html";i:1583049507;s:62:"D:\phpstudy\WWW\test\application\index\view\common\script.html";i:1583049507;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="header-navbar">
                    <ul class="nav navbar-nav" data-current="<?php echo (isset($__CHANNEL__['id']) && ($__CHANNEL__['id'] !== '')?$__CHANNEL__['id']:0); ?>">
                        ...
                        <?php $__GP8lXdTzbk__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav","type"=>"top","condition"=>"1=isnav"]); if(is_array($__GP8lXdTzbk__) || $__GP8lXdTzbk__ instanceof \think\Collection || $__GP8lXdTzbk__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__GP8lXdTzbk__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
                        <!--判断是否有子级或高亮当前栏目-->
                        <li class="<?php if($nav['has_child']): ?>dropdown<?php endif; if($nav->is_active): ?> active<?php endif; ?>">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <?php $__Dqev054uNg__ = \addons\cms\model\Channel::getChannelList(["id"=>"sub","type"=>"son","typeid"=>$nav['id'],"condition"=>"1=isnav"]); if(is_array($__Dqev054uNg__) || $__Dqev054uNg__ instanceof \think\Collection || $__Dqev054uNg__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__Dqev054uNg__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub): $mod = ($i % 2 );++$i;?>
                                <li><a href="<?php echo $sub['url']; ?>"><?php echo $sub['name']; ?></a></li>
                                <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__Dqev054uNg__; ?>
                            </ul>
                        </li>
                        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__GP8lXdTzbk__; ?>
                        <!--如果需要无限级请使用cms:nav标签-->
