<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:55:"D:\phpstudy\WWW\test\addons\cms\view\default\index.html";i:1591855994;s:63:"D:\phpstudy\WWW\test\addons\cms\view\default\common\layout.html";i:1591855994;s:67:"D:\phpstudy\WWW\test\addons\cms\view\default\common\index_list.html";i:1591855994;s:61:"D:\phpstudy\WWW\test\addons\cms\view\default\common\item.html";i:1591855994;s:64:"D:\phpstudy\WWW\test\addons\cms\view\default\common\sidebar.html";i:1591855994;}*/ ?>
<!DOCTYPE html>
<!--[if lt IE 7]>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav" data-current="<?php echo (isset($__CHANNEL__['id']) && ($__CHANNEL__['id'] !== '')?$__CHANNEL__['id']:0); ?>">
                    ...
                    <?php $__qEdM4myoQL__ = \addons\cms\model\Channel::getChannelList(["id"=>"nav","type"=>"top","condition"=>"1=isnav"]); if(is_array($__qEdM4myoQL__) || $__qEdM4myoQL__ instanceof \think\Collection || $__qEdM4myoQL__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__qEdM4myoQL__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
                    <!--判断是否有子级或高亮当前栏目-->
                    <li class="<?php if($nav['has_child']): ?>dropdown<?php endif; if($nav->is_active): ?> active<?php endif; ?>">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <?php $__AOTiILskmv__ = \addons\cms\model\Channel::getChannelList(["id"=>"sub","type"=>"son","typeid"=>$nav['id'],"condition"=>"1=isnav"]); if(is_array($__AOTiILskmv__) || $__AOTiILskmv__ instanceof \think\Collection || $__AOTiILskmv__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__AOTiILskmv__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub): $mod = ($i % 2 );++$i;?>
                            <li><a href="<?php echo $sub['url']; ?>"><?php echo $sub['name']; ?></a></li>
                            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__AOTiILskmv__; ?>
                        </ul>
                    </li>
                    <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__qEdM4myoQL__; ?>
                    <!--如果需要无限级请使用cms:nav标签-->
            ...
            <div class="swiper-container index-focus">
                ...
                <div id="index-focus" class="carousel slide carousel-focus" data-ride="carousel">
                    <ol class="carousel-indicators">
                        <?php $__Si0X1bJZn8__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"indexfocus","row"=>"5"]); if(is_array($__Si0X1bJZn8__) || $__Si0X1bJZn8__ instanceof \think\Collection || $__Si0X1bJZn8__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__Si0X1bJZn8__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;?>
                        <li data-target="#index-focus" data-slide-to="<?php echo $i-1; ?>" class="<?php if($i==1): ?>active<?php endif; ?>"></li>
                        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__Si0X1bJZn8__; ?>
                    </ol>
                    <div class="carousel-inner" role="listbox">
                        <?php $__smCv4khbwd__ = \addons\cms\model\Block::getBlockList(["id"=>"block","name"=>"indexfocus","row"=>"5"]); if(is_array($__smCv4khbwd__) || $__smCv4khbwd__ instanceof \think\Collection || $__smCv4khbwd__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__smCv4khbwd__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$block): $mod = ($i % 2 );++$i;?>
                        ...
                        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__smCv4khbwd__; ?>
                    </div>
            ...
            <div class="panel panel-default index-gallary">
                ...
                <div class="panel-body">
                    <div class="related-article">
                        <div class="row">
                            <!-- S 热门图集 -->
                            <?php $__Y9ZU6uTinA__ = \addons\cms\model\Archives::getArchivesList(["id"=>"item","model"=>2,"orderby"=>"views","row"=>"4"]); if(is_array($__Y9ZU6uTinA__) || $__Y9ZU6uTinA__ instanceof \think\Collection || $__Y9ZU6uTinA__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__Y9ZU6uTinA__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                            ...
                            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__Y9ZU6uTinA__; ?>
                            <!-- E 热门图集 -->
                        </div>
                    </div>
                </div>
                    ...
                    <h3 class="panel-title">
                        ...
                        <div class="more hidden-xs">
                            <ul class="list-unstyled list-inline">
                                <!-- E 栏目筛选 -->
                                <?php $__vsd2HYuCoy__ = \addons\cms\model\Channel::getChannelList(["id"=>"item","condition"=>"'list'=type","limit"=>"6"]); if(is_array($__vsd2HYuCoy__) || $__vsd2HYuCoy__ instanceof \think\Collection || $__vsd2HYuCoy__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__vsd2HYuCoy__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                                <li><?php echo $item['textlink']; ?></li>
                                <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__vsd2HYuCoy__; ?>
                                <!-- E 栏目筛选 -->
                            </ul>
                        </div>
                    </h3>
...
<!-- S 首页列表 -->
<?php $__ujGlox0S56__ = \addons\cms\model\Archives::getArchivesList(["id"=>"item","cache"=>"false","orderby"=>"weigh","limit"=>"$offset,10"]); if(is_array($__ujGlox0S56__) || $__ujGlox0S56__ instanceof \think\Collection || $__ujGlox0S56__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__ujGlox0S56__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
<article class="article-item">
    ...
    <div class="gallery-article">
        ...
        <div class="row">
            <?php if(is_array($item['images_list']) || $item['images_list'] instanceof \think\Collection || $item['images_list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $item['images_list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$img): $mod = ($i % 2 );++$i;?>
            <div class="col-sm-3 col-xs-6">
                <a href="<?php echo $item['url']; ?>" class="img-zoom">
                    <div class="embed-responsive embed-responsive-4by3">
                        <img src="<?php echo $img; ?>" alt="<?php echo $item['title']; ?>" class="embed-responsive-item">
                    </div>
                </a>
            </div>
...
<?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__ujGlox0S56__; ?>
<!-- E 首页列表 -->
            ...
            <div class="panel panel-default lasest-update">
                ...
                <div class="panel-body">
                    <ul class="list-unstyled">
                        <?php $__JYQEsgRpWq__ = \addons\cms\model\Archives::getArchivesList(["id"=>"new","row"=>"8","orderby"=>"id","orderway"=>"desc"]); if(is_array($__JYQEsgRpWq__) || $__JYQEsgRpWq__ instanceof \think\Collection || $__JYQEsgRpWq__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__JYQEsgRpWq__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?>
                        <li>
                        ...
                        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__JYQEsgRpWq__; ?>
                    </ul>
                </div>
                <!-- E 最近更新 -->
            </div>
...
<div class="panel panel-default hot-article">
    ...
    <div class="panel-body">
        <?php $__YuwfikL1QD__ = \addons\cms\model\Archives::getArchivesList(["id"=>"item","model"=>1,"row"=>"10","flag"=>"recommend","orderby"=>"id","orderway"=>"asc"]); if(is_array($__YuwfikL1QD__) || $__YuwfikL1QD__ instanceof \think\Collection || $__YuwfikL1QD__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__YuwfikL1QD__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
        ...
        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__YuwfikL1QD__; ?>
    </div>
</div>
<!-- E 热门资讯 -->
...
<div class="panel panel-default hot-tags">
    ...
    <div class="panel-body">
        <div class="tags">
            <?php $__kmL8tdbxX1__ = \addons\cms\model\Tags::getTagsList(["id"=>"tag","orderby"=>"rand","limit"=>"30"]); if(is_array($__kmL8tdbxX1__) || $__kmL8tdbxX1__ instanceof \think\Collection || $__kmL8tdbxX1__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__kmL8tdbxX1__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tag): $mod = ($i % 2 );++$i;?>
            <a href="<?php echo $tag['url']; ?>" class="tag"> <span><?php echo $tag['name']; ?></span></a>
            <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__kmL8tdbxX1__; ?>
        </div>
    </div>
</div>
<!-- E 热门标签 -->
...
<div class="panel panel-default recommend-article">
    ...
    <div class="panel-body">
        <?php $__FozEydCkK1__ = \addons\cms\model\Archives::getArchivesList(["id"=>"item","model"=>3,"row"=>"10","flag"=>"recommend","orderby"=>"id","orderway"=>"asc","addon"=>"downloads"]); if(is_array($__FozEydCkK1__) || $__FozEydCkK1__ instanceof \think\Collection || $__FozEydCkK1__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__FozEydCkK1__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
        <div class="media media-number">
            <div class="media-left">
                <span class="num"><?php echo $i; ?></span>
            </div>
        ...
        <?php endforeach; endif; else: echo "" ;endif; $__LASTLIST__=$__FozEydCkK1__; ?>
    </div>
</div>
<!-- E 推荐下载 -->
